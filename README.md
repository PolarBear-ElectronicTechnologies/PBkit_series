...
Требует root-доступ. Пароль смотрите в нашей документации, он однотипный для всех проектов.
При желании задайте совй новый пароль.
